...
class Day5Main {
    ...
    val instructions =
        Files.readAllLines(Paths.get(System.getProperty("user.dir"), "src/main/kotlin/y2022/day5/data.txt")).map {
    ...
    val stacks = Files.readAllLines(Paths.get(System.getProperty("user.dir"), "src/main/kotlin/y2022/day5/stacks.txt"))
        ?.let { rawList ->
